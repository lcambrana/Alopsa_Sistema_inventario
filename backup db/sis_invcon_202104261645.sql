...
-- Script date 26/04/2021 16:45:16
...
CREATE 
DEFINER = 'root'@'localhost'
PROCEDURE insert_fallastir(in iddtir int,in ubicacion char(50),in f char(20),in op bit,in obser varchar(50) )
begin
	start transaction;

INSERT INTO sis_invcon.fallas_tir (id_datostir, ubicacion, falla, opcionfalla, observacion)
  VALUES (iddtir, ubicacion, f, op, obser);
...
-- 
-- Dumping data for table datortir
--
-- Table sis_invcon.datortir does not contain any data (it is empty)
...
--
-- Table sis_invcon.fallas_tir does not contain any data (it is empty)
...
--
-- Table sis_invcon.bitacora does not contain any data (it is empty)
